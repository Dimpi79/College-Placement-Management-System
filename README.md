...
## Introduction
The **College Placement Management System** is a web application designed to streamline and digitize the placement process in colleges and universities. It is a generic campus hiring portal supporting multiple roles: students, TPO (Training and Placement Officer), management, and super admin. The system aims to reduce manual effort, improve transparency, and provide real-time tracking of the placement cycle.
