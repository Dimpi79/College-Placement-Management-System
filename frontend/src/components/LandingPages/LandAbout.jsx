    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-md md:text-lg max-w-3xl mx-auto text-gray-700 px-3">
          CPMS (College Placement Management System) is a comprehensive platform that streamlines campus recruitment, manages placement activities, and empowers students to explore career opportunities efficiently.
        </p>
      </div>
